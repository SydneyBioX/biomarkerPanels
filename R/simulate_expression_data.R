#' Simulate gene expression data for biomarker panel testing
#'
#' Simulates log-scale gene expression datasets with distributional shifts.
#' Useful for benchmarking panel optimization routines under n << p conditions.
#'
...
#'
#' @return A list with `x_list` (list of matrices), `y_list` (list of factors),
#'   and `metadata` (simulation parameters).
#'
#' @export
