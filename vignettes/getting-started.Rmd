...
size penalty. We also tighten the classification threshold for sensitivity.

```{r objectives}
objectives <- define_objectives(
  losses = c("sensitivity", "specificity", "num_features"),
  params = list(sensitivity = list(threshold = 0.6))
)
...
result <- optimize_panel(
  x = cohorts$x_list,
  y = cohorts$y_list,
  objectives = define_objectives(losses = c("specificity", "num_features")),
